            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
                    <img
                        ...
                        src="https://mma.prnewswire.com/media/2010443/Canaccord_Genuity_Group_Inc__CANACCORD_GENUITY_GROUP_INC__SPECIA.jpg?p=publish"
                        alt="Transistor"
                        width={158}
                        height={48}
                    />
                    <img
                        className="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
                        src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/EY_logo_2019.svg/440px-EY_logo_2019.svg.png"
                        alt="Reform"
                        width={158}
                        height={48}
                    />
