        ...
        <>
            ...
            <div className="bg-white px-6 pt-12 pb-24 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    <h2 className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Philanthropy</h2>
                    ...
                    <div className="lg:pr-4">
                        <div className="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
                            <img
                                ...
                                src="h8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2669&q=80"
                                alt=""
                            />
                            ...
                            >
                                <div
                                    className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#d6d3d5] to-[#183C6D] opacity-40"
                                    style={{
                                        clipPath:
